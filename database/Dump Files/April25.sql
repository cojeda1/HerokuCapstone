...
CREATE TABLE `accountant_notifications` (
  ...
  `ct_id` int(11) unsigned DEFAULT NULL,
  ...
  KEY `accountant_notifications_ct_id` (`ct_id`),
  ...
  CONSTRAINT `accountant_notifications_ct_id` FOREIGN KEY (`ct_id`) REFERENCES `researchers_timestamps` (`ct_id`)
...
INSERT INTO `accountants_timestamps` VALUES (4,'Accountant','approve','2017-04-13 17:27:36',2,3,'Joan Ortiz'),(5,'Accountant','Assigned Transaction','2017-04-23 23:00:45',6,3,'Joan Ortiz'),(12,'Accountant','Assigned Transaction','2017-04-24 21:42:04',7,3,'Joan Ortiz');
...
INSERT INTO `items` VALUES (1,'book',50,2,2),(2,'markers',10,1,2),(3,'BEST ITEM',25.25,4483,2),(5,'BEST ITEM',25.25,4483,2),(6,'BEST ITEM',25.25,4483,2),(7,'MAMA MIA',5,52,29),(8,'MAMA MIA',5,52,30);
...
INSERT INTO `researcher_notifications` VALUES (1,'Your transaction was assigned to Joan Ortiz.',0,12,NULL,1);
...
INSERT INTO `transactions` VALUES (2,'2017-03-02 04:00:00','2017-03-14 20:00:00','approved','2017-03-22',0,1,4),(3,'2017-03-02 04:00:00','2017-03-22 11:00:00','approved','2017-04-18',1,6,4),(4,'2017-03-02 04:00:00','2017-03-08 12:00:00','approved','2017-03-01',1,6,3),(5,'2017-03-18 13:00:00','2017-03-04 15:00:00','in_progress','2017-03-14',0,2,3),(6,'2017-03-02 04:00:00','2017-03-28 07:00:00','in progress','2017-03-03',0,2,3),(7,'2017-03-02 04:00:00','2017-03-31 17:00:00','in progress','2017-03-21',0,1,3),(8,'2017-03-02 04:00:00','2017-03-20 11:00:00','escalated','2017-03-18',0,1,3),(9,'2017-03-02 04:00:00','2017-03-25 04:00:00','escalated','2017-03-27',1,6,3),(10,'2017-03-02 04:00:00','2017-03-18 16:00:00','unathorized charge','2017-03-03',1,6,5),(11,'2017-03-02 04:00:00','2017-03-24 12:00:00','unathorized charge','2017-03-01',1,6,3),(12,'2017-03-02 04:00:00','2017-03-23 08:00:00','unassigned','2017-03-11',0,1,6),(13,'2017-03-02 04:00:00','2017-03-11 04:00:00','unassigned','2017-03-01',0,1,3),(18,'2017-04-02 02:56:21',NULL,'approved','0000-00-00',1,6,4),(19,NULL,NULL,'approved','0000-00-00',1,6,4),(20,NULL,NULL,'approved','0000-00-00',1,6,4),(21,NULL,NULL,'approved','0000-00-00',1,6,4),(27,'2017-04-03 04:27:39',NULL,'in_progress','0000-00-00',0,1,NULL),(28,'2017-04-03 04:31:38',NULL,'in_progress','0000-00-00',0,1,NULL),(29,'2017-04-03 04:32:23',NULL,'in_progress','0000-00-00',0,1,NULL),(30,'2017-04-03 04:32:31',NULL,'in_progress','0000-00-00',0,1,NULL);
...
-- Dump completed on 2017-04-25 15:04:03
