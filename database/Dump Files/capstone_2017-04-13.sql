...
# Database: capstone
# Generation Time: 2017-04-13 18:03:20 +0000
# ************************************************************
...
INSERT INTO `accountants` (`accountant_id`, `roles_id`, `user_info_id`)
VALUES
	(3,2,'11'),
	(4,2,'7'),
	(5,2,'3'),
...
# Dump of table accountants_timestamps
# ------------------------------------------------------------
...
INSERT INTO `accountants_timestamps` (`at_id`, `role`, `action`, `timestamp`, `transaction_id`, `accountant_id`, `name`)
VALUES
	(4,'Accountant','approve','2017-04-13 13:27:36',2,3,'Joan Ortiz');

/*!40000 ALTER TABLE `accountants_timestamps` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table researchers_timestamps
# ------------------------------------------------------------
...
INSERT INTO `researchers_timestamps` (`ct_id`, `role`, `action`, `timestamp`, `transaction_id`, `researcher_id`, `name`)
VALUES
	(3,'Researcher','edit','2017-04-13 13:28:06',2,1,'Jose Perez'),
	(4,'Researcher','create','2017-04-13 13:28:12',2,1,'Jose Perez'),
	(5,'Researcher','deletion','2017-04-13 13:28:34',3,2,'Luis Negron');
...
INSERT INTO `comments` (`comment_id`, `created_at`, `updated_at`, `body_of_comment`, `transaction_id`, `accountant_id`)
VALUES
	(1,'2017-03-02 00:00:00','2017-03-02 00:00:00','Not justified',2,3),
	(2,'2017-03-02 00:00:00','2017-03-02 00:00:00','Items cannot be approved',2,3),
...
INSERT INTO `credit_card` (`cc_id`, `credit_card_number`, `name_on_card`, `researcher_id`, `expiration_date`, `is_active`, `reason`)
VALUES
...
INSERT INTO `images` (`image_id`, `image_path`)
VALUES
...
INSERT INTO `items` (`item_id`, `item_name`, `item_price`, `quantity`, `transaction_id`)
VALUES
	(1,'book',50,2,2),
	(2,'markers',10,1,2),
...
INSERT INTO `items_paid_from` (`ipf_id`, `ra_id`, `item_id`)
VALUES
	(1,0,1),
	(2,1,2),
	(3,3,2),
...
# Dump of table research_accounts
# ------------------------------------------------------------
...
INSERT INTO `research_accounts` (`ra_id`, `research_nickname`, `ufis_account_number`, `frs_account_number`, `unofficial_budget`, `budget_remaining`, `principal_investigator`, `be_notified`)
VALUES
...
# Dump of table researcher_has_accounts
# ------------------------------------------------------------
...
INSERT INTO `researcher_has_accounts` (`rha_id`, `ra_id`, `researcher_id`)
VALUES
	(0,0,1),
	(1,1,1),
	(2,2,2),
...
INSERT INTO `researchers` (`researcher_id`, `roles_id`, `user_info_id`, `amex_account_id`, `employee_id`, `accountant_id`)
VALUES
	(1,3,'0','1234','100',3),
	(2,3,'1','4321','101',4),
	(3,3,'2','2345','102',5),
...
INSERT INTO `roles` (`roles_id`, `system_roles`)
VALUES
	(1,'administrator'),
	(2,'accountant'),
	(3,'researcher'),
...
# Dump of table transaction_images
# ------------------------------------------------------------
...
INSERT INTO `transaction_images` (`transaction_image_id`, `image_id`, `tinfo_id`)
VALUES
	(1,5,20),
	(2,6,20),
	(3,7,20),
...
INSERT INTO `transactions` (`transaction_id`, `created_at`, `updated_at`, `status`, `billing_cycle`, `is_reconciliated`, `researcher_id`, `accountant_id`)
VALUES
	(2,'2017-03-02 00:00:00','2017-03-14 16:00:00','approved','2017-03-22',0,1,4),
	(3,'2017-03-02 00:00:00','2017-03-22 07:00:00','approved','2017-04-18',1,6,4),
	(4,'2017-03-02 00:00:00','2017-03-08 08:00:00','approved','2017-03-01',1,6,3),
	(5,'2017-03-18 09:00:00','2017-03-04 11:00:00','in progress','2017-03-14',0,2,3),
	(6,'2017-03-02 00:00:00','2017-03-28 03:00:00','denied','2017-03-03',0,2,3),
	(7,'2017-03-02 00:00:00','2017-03-31 13:00:00','denied','2017-03-21',0,1,3),
	(8,'2017-03-02 00:00:00','2017-03-20 07:00:00','escalated','2017-03-18',0,1,3),
	(9,'2017-03-02 00:00:00','2017-03-25 00:00:00','escalated','2017-03-27',1,6,3),
	(10,'2017-03-02 00:00:00','2017-03-18 12:00:00','unathorized charge','2017-03-03',1,6,5),
	(11,'2017-03-02 00:00:00','2017-03-24 08:00:00','unathorized charge','2017-03-01',1,6,3),
	(12,'2017-03-02 00:00:00','2017-03-23 04:00:00','unassigned','2017-03-11',0,1,6),
	(13,'2017-03-02 00:00:00','2017-03-11 00:00:00','unassigned','2017-03-01',0,1,3),
	(18,'2017-04-01 22:56:21',NULL,'approved','0000-00-00',1,6,4),
	(19,NULL,NULL,'approved','0000-00-00',1,6,4),
	(20,NULL,NULL,'approved','0000-00-00',1,6,4),
	(21,NULL,NULL,'approved','0000-00-00',1,6,4),
	(27,'2017-04-03 00:27:39',NULL,'in_progress','0000-00-00',0,1,NULL),
	(28,'2017-04-03 00:31:38',NULL,'in_progress','0000-00-00',0,1,NULL),
	(29,'2017-04-03 00:32:23',NULL,'in_progress','0000-00-00',0,1,NULL),
	(30,'2017-04-03 00:32:31',NULL,'in_progress','0000-00-00',0,1,NULL);

/*!40000 ALTER TABLE `transactions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table transactions_info
# ------------------------------------------------------------
...
INSERT INTO `transactions_info` (`tinfo_id`, `transaction_number`, `receipt_number`, `receipt_image_path`, `date_bought`, `company_name`, `description_justification`, `total`, `transaction_id`)
VALUES
...
INSERT INTO `user_info` (`user_info_id`, `first_name`, `last_name`, `department`, `office`, `phone_number`, `job_title`, `email`, `password`, `created_at`, `updated_at`)
VALUES
	('0','Jose','Perez','ECE','S-113','1234567890','Professor','jose.perez@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('1','Luis','Negron','ECE','S-222','1234567890','Professor','luis.negron@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('10','Michelle','Velez','ECE','S-409','1234567890','Professor','michelle.velez@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('11','Joan','Ortiz','ECE','S-410','123','Accountant','joan.ortiz@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('12','Unassigned','Accountant','','','','','','','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('2','Victor','Beltran','ECE','S-403','1234567890','Professor','victor.beltran@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('3','Carlos','Rodriguez','ECE','S-401','1234567890','Accountant','carlos.rodriguez@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('4','Maria','Rolon','ECE','S-402','1234567890','Professor','maria.rolon@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('5','Juan','Ortega','ECE','S-404','1234567890','Professor','juan.ortega@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('6','Coral','Suazo','ECE','S-405','1234567890','Professor','coral.suazo@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('7','Bryan','Matos','ECE','S-406','1234567890','Accountant','bryan.matos@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('8','Christian','Rivera','ECE','S-407','1234567890','Professor','christian.rivera@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00'),
	('9','Luz','Calderon','ECE','S-408','1234567890','Professor','luz.calderon@upr.edu','test','2017-03-22 00:00:00','2017-03-22 00:00:00');
