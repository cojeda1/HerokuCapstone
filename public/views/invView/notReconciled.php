...
<body  ng-app='homeApp' ng-controller='recCtrl'>
        ...
        <div class = "col-lg-12 separate">
          <div>
            <table class = "table table-hover">
              ...
              <tbody class="table">
                <tr dir-paginate ="transaction in info | orderBy:sortKey:reverse|filter:search|itemsPerPage:pageSize">
