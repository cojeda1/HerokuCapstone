...
<body  ng-app='homeApp' ng-controller='coCtrl'>
  ...
  <div class="navStyle">
    ...
    <div class="main">
      <md-content>
        ...
        <div class="container">
          <div>
            <h1>Transactions of Co-Investigator: </h1>
            ...
            <div class = "form-group">
              ...
              <div class = "col-sm-4">
                <md-button class = "md-raised" ng-click = "viewCycle()">
                  ...
                  <md-button class="md-raised md-primary" ng-click = "viewAll()">View All</md-button>
        ...
        <div class = "container separate">
          <div>
            <table class = "table table-hover">
              ...
              <tbody class="table">
                <tr dir-paginate ="transaction in coTransactions | orderBy:sortKey:reverse|filter:search|itemsPerPage:pageSize">
                  <td>{{transaction.date_bought | date}}</td>
                  <td>{{transaction.company_name}}</td>
                  <td class="currency">{{transaction.total | currency}}</td>
                  <td>{{transaction.status}}</td>
                  <td><a ng-click="audit(transaction.transaction_id, transaction.researcher_id)"><span class="glyphicon glyphicon-open-file"></span></a></td>
                </tr>
              </tbody>
            </table>
          </div>
